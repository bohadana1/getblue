if (window.__BLUE_TAG_LOADED__)
    throw "";
window.__BLUE_TAG_LOADED__ = !0,
window.blue = {},
...
function(e, t) {
    ...
    t[e] = function(e, t) {
        ...
        "complete" === document.readyState || "interactive" === document.readyState ? setTimeout(r, 1) : i || (document.addEventListener ? (document.addEventListener("DOMContentLoaded", r, !1),
...
documentReady((function() {
    ...
    window.blue_ulc = "",
    setLastClickBlue(),
    !0 === isCookieEnabled()) && ("" != (e = getCookieBlue("blueID")) && "null" !== e && null !== e ? window.bluecpy_id = e : setCookieBlue("blueID", window.bluecpy_id, 365));
...
executeFlow = function(e) {
    ...
    for (i = 0; i < t.length; i++)
        loadFunction(t[i].event, t[i].value);
...
function setLastClickBlue() {
    ...
    t.length ? (window.blue_ulc = t,
    !0 === isCookieEnabled() && setCookieBlue("blueULC", t, 30),
    !0 === isSessionStorageEnabled() && setSessionStorage("blueULC", t),
    !0 === isLocalStorageEnabled() && setLocalStorage("blueULC", t)) : (!0 === isCookieEnabled() && getCookieBlue("blueULC").length && (window.blue_ulc = getCookieBlue("blueULC")),
...
function expireULCBlue() {
    document.cookie = "blueULC=;domain=." + getDomainBlue(window.location.protocol + "//" + window.location.hostname) + ";expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;",
    setSessionStorage("blueULC", ""),
    setLocalStorage("blueULC", "")
}
function getDomainBlue(e) {
    if (3 == e.split(".").length)
        var t = /(?:www\.)?((?:[a-z0-9](?:[a-z0-9\-]{0,61}[a-z0-9])?\.)+[a-z0-9][a-z0-9\-]{0,61}[a-z0-9])/i;
    else
        t = /(?:www\.)?(?:.+?\.)?([a-z0-9\-]+\.(?:[a-z\.]{2,6})$)/i;
    const o = t.exec(e);
    return o ? o[1] : null
}
...
blue_obj.prototype.getSslWidget = function(e, t) {
    var o = blue_obj[instId].getAttributes()
      ...
      , i = 0;
    return top !== self && (i = 1),
    "https://widget.getblue.io/event/?cId=" + e + "&tName=" + t + "&pId=" + o.blueProductId + "&revenue=" + o.transactionTotal + "&orderId=" + o.transactionId + "&p1=&p2=e%3Dvp&p3=e%3Ddis&adce=1&dtycbr=87954&fp=" + o.fingerprint + "&blueID=" + window.bluecpy_id + "&ulc=" + window.blue_ulc + "&v=" + window.blue_v + "&if=" + i + "&nocache=" + n
}
,
...
createScriptElement = function(e) {
    ...
    return t.setAttribute("async", "true"),
